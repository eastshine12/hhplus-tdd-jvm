...
![image1.png](src%2Fmain%2Fresources%2Fimg%2Fimage1.png)
...
![성공하거나](src%2Fmain%2Fresources%2Fimg%2Fimage2.png)
성공하거나

![실패한다.](src%2Fmain%2Fresources%2Fimg%2Fimage3.png)
실패한다.
...
![image4.png](src%2Fmain%2Fresources%2Fimg%2Fimage4.png)
...
![image5.png](src%2Fmain%2Fresources%2Fimg%2Fimage5.png)
...
![image6.png](src%2Fmain%2Fresources%2Fimg%2Fimage6.png)

`Synchronized` 덕분에 위와 같이 동시에 충전해도 각 유저 별로 1000원이 충전이 잘 되는 것을 확인할 수 있습니다.

그런데 이상한 점이 있습니다. 예리한 관찰력이라면 이미 발견했을 수도 있는데, 바로 테스트 결과의 수행 시간입니다. `add()` 를 수행하는데 약 0.1초가 걸린다면 각 유저 별로 1초가 걸리니 테스트도 약 1초가 수행되어야 합니다. 하지만 *유저2는 유저1이 가져간 락을 받기 위해 대기 상태에 빠지고 결국 수행 시간이 2초가 넘어가는 것을 확인할 수 있습니다.* 여기서 `Synchronized` 의 단점을 발견할 수 있습니다.
...
![image7.png](src%2Fmain%2Fresources%2Fimg%2Fimage7.png)
...
![image8.png](src%2Fmain%2Fresources%2Fimg%2Fimage8.png)
